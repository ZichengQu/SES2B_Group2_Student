		...
		<div class="header_onBlockBg " style="display: none; ">
			...
			<div class="header_onBlockIn ">
				<ul class="header_onList wid-4 ">
					<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
					<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
					<li><a href="MyInfo.jsp" class="hoverRed" style="text-decoration: none;">Profile</a></li><!--<li><a href="# ">Profile</a></li>-->
					<li><a href="Bookings.jsp" class="hoverRed" style="text-decoration: none;">Bookings</a></li><!--<li><a href="# ">Bookings</a></li>-->
				</ul>
			</div>
		</div>
