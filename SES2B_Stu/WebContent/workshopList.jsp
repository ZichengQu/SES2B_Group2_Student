	...
	<div class="header_content">
		...
		<div class="header_contentBlock ">
			<div class="header_ulBlock ">
				<a href="UtsHelpsHome.html" style="text-decoration: none;" class="header_liBlock current ">Home</a> 
				...
				<a href="MyInfo.html " style="text-decoration: none;" class="header_liBlock ">My Info</a>
				<a href="Wp_book.html " style="text-decoration: none;" class="header_liBlock ">Registration</a>
				...
				<a href="stu_login.html" style="text-decoration: none;" class="header_liBlock1 "><img style="" src="img/logoff.png " alt=" " width="20 " height="20 "></a>
		...
		<div class="header_onBlockBg " style="display: none; ">
			...
			<div class="header_onBlockIn ">
				<ul class="header_onList wid-4 ">
					<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
					<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
					<li><a href="MyInfo.html " class="hoverRed" style="text-decoration: none;">Profile</a></li>
					<li><a href="Bookings.html " class="hoverRed" style="text-decoration: none;">Bookings</a></li>
				</ul>
			</div>
		</div>
...
<div id="wrapper">
	<div id="container">
		...
		<div id="session" class="box">
			...
			<div style="float: right; font-size: 18px; font-weight: 580; line-height: 70px; letter-spacing: 0.8px; ">Sessions</div>
			<div class="auo">	
		...
		<div id="detail" class="box" style="display: none;">
			...
			<div id="detail_title">
				<span class="left_title">Title</span>
				<span class="right_content" style="padding-left: 150px">Improve Your Grammar 1</span>
			</div>
			<div id="detail_room">
				<span class="left_title">Room</span>
				<span class="right_content" style="padding-left: 138px">CB05C.01.020</span>
			</div>
			<div id="detail_date">
				<span class="left_title">Date</span>
				<span class="right_content" style="padding-left: 150px">20/08/2019</span>
			</div>
			<div id="detail_time">
				<span class="left_title">Time</span>
				<span class="right_content" style="padding-left: 150px">10:30-12:00</span>
			</div>
			<div id="detail_place">
				<span class="left_title">Place Available</span>
				<span class="right_content" style="padding-left: 65px">12</span>
			</div>
